...
1. Download the files in this repository to a directory on your computer. e.g. 'git clone git://github.com/ryanfb/reconciliation_service_skeleton.git recon_skeleton'
...
3. Run 'pleiades_service.py' e.g. 'python pleiades_service.py'.  This will start a reconciliation service on port 5000 which you can use with Google Refine.
